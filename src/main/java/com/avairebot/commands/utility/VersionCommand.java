...
public class VersionCommand extends Command {
    ...
    public String getDescription() {
        return "Displays the current version of Xenon that is running. If the version is outdated the new version will be shown as well as what type of changes have been made.";
    }
    ...
    public boolean onCommand(CommandMessage context, String[] args) {
        ...
        if (latestVersion == null) {
            return sendErrorMessage(context, "Failed to fetch the latest version of Xenon, try again later.");
        }
