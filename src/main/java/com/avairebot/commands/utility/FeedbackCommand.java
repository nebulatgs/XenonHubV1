...
public class FeedbackCommand extends Command {
    ...
    public String getDescription() {
        return "Send feedback about the server back to the developers and the staff team, any message passed to the command will be sent in the feedback channel on the bot development server. Please contact DORAN03 if you have any questions.";
    }
